<x-layout>
    <div class="container-fluid px-4 py-5 text-center text-white" style="background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('https://images.unsplash.com/photo-1521737711867-e3b97375f902?q=80&w=1974&auto=format&fit=crop'); background-size: cover; background-position: center;">
        <div class="py-5">
            <h1 class="display-3 fw-bold">Entra nel nostro Team</h1>
            <div class="col-lg-8 mx-auto">
                <p class="fs-5 mb-4 lead">Siamo una squadra dinamica e in continua crescita, sempre alla ricerca di persone appassionate e talentuose per unirsi a noi.</p>
            </div>
        </div>
    </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select name="role" id="role" class="form-select form-select-lg">
                                            ...
                                            @if (!Auth::user()->is_admin) <option value="admin">Amministratore</option> @endif
                                            @if (!Auth::user()->is_revisor) <option value="revisor">Revisore</option> @endif
                                            @if (!Auth::user()->is_writer) <option value="writer">Redattore</option> @endif
                                        </select>
                                    </div>
